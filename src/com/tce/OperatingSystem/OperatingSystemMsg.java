package com.tce.OperatingSystem;
import com.tce.OperatingSystem.MonitorInfoBean;
...
public class OperatingSystemMsg {
    ...
    public static void main(String[] args) throws Exception {
        MonitorInfoBean monitorInfo = new OperatingSystemMsg().getMonitorInfoBean();
